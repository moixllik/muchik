...
1. Existen dos tipos de verbos

   * Verbo sustantivo: Ser = `chi`
   * Verbo adjetivo: Traer = `met`

2. Propiedades del verbo
...
3. Los verbos compuestos se forman de los participios acabados en `pæc` se añade `oiñ` u `oz`

   * `funo pæc` -> `funopæc oiñ` (soler comer), `funopæc oz`
   * `mita pæc` -> `mitapæc oiñ` (soler traer), `mitapæc oz`
  
4. Participios terminados en `do`
...
7. Uso de `pa`, para agregar "tener"
