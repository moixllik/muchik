...
1. Se presenta como una terminación invariable en genero y numero

    * buen hombre = `peño ñofæn`
    * buena mujer = `peño mecherræc`

1. Si el adjetivo termina en vocal, se adjunta la sílaba `io` entre atributo y núcleo

    * caballo macho = `ñancuio col`
    * el que es yunga = `yungaio chipæc`

1. Si al adjetivo se añade una `o` se convierte en  plural. A estos plurales que terminan en `æn` se les añade una `o`

    * cañas grandes = `mætcæn o kumo`
    * caballos grandes = `utzhæn o col`

1. Los adjetivos no varían en el Caso

    * de todo hombre = `izcæc ñofnæro`
    * para todo hombre = `izcæc ñofnæro pæn`

1. Los adjetivos partitivos numerales y otros se ponen en el Caso del sustantivo

    * un hombre = `onæc ñofæn`
    * muchos hombre = `tunituni ñofæn`

1. Los adjetivos varían en el Caso si están sustantivados

    * de todo = `izçæro`
    * para todo = `izçæro pæn`

1. El adjetivo presenta vocablos y construcciones gramaticales, en superlativo

    * muy buen hombre = `campeño ñofæn`
    * de todo hombre = `izçæc ñofnær lequich`

1. Se pueden formar oraciones con adjetivos comparativos
